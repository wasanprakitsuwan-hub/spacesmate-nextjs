  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'อพาร์ทเม้นท์ใช้อัตรา 10%: Service Charge = (ค่าเช่าทั้งหมด − ค่าไฟ − ค่าน้ำ − เงินประกัน − ค่าปรับล่าช้า) × 10% + ค่าปรับล่าช้า สาธารณูปโภคและเงินประกันถูกหักออกก่อนคำนวณ เนื่องจากเป็นค่าใช้จ่ายที่ส่งต่อให้ผู้เช่า',
      },
      {
        q: 'ค่าบริการบริหารคอนโดคิดอย่างไร?',
        a: 'คอนโดใช้อัตรา 15%: Service Charge = (ค่าเช่าทั้งหมด − ค่าไฟ − ค่าน้ำ − เงินประกัน − ค่าปรับล่าช้า) × 15% + ค่าปรับล่าช้า อัตรา 15% รวมการตลาดหาผู้เช่า (เทียบเท่า 1 เดือน commission) 8% และบริหารจัดการรายเดือน 7% SpacesMate อยู่กับเจ้าของตลอดสัญญา ต่างจากเอเจนต์ที่จบงานหลังหาผู้เช่าได้',
      },
      {
      ...
      },
      {
        ...
        a: 'SpacesMate ใช้ EasyRenz เป็นระบบ Property Management Software ในการบันทึกรายรับรายจ่าย ติดตามสถานะห้อง และออกรายงานให้เจ้าของ ค่า EasyRenz แสดงเป็น line item แยกในใบแจ้งบัญชีรายเดือน (ไม่รวมใน 10%/15%) เพื่อความโปร่งใส',
      },
    ],
  },
]
