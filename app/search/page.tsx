...
function adaptDbListing(l: any): Property {
  ...
  return {
    ...
    image: (Array.isArray(l.images) ? l.images.find((img: string) => img.startsWith('https://')) : null) ?? '',
    images: Array.isArray(l.images) ? l.images.filter((img: string) => img.startsWith('https://')) : [],
