...
const SERVICES = [
  ...
  },
  {
    ...
    description: 'ลงประกาศเช่าอสังหาริมทรัพย์บน SpacesMate ด้วยระบบ Fair Rotation ที่ทำให้ทุกประกาศมีโอกาสเท่าเทียมกันในการแสดงผล',
    features: ['เผยแพร่ทันทีหลังชำระ', 'รูปภาพและวิดีโอคุณภาพสูง', 'ระบบ Fair Rotation', 'แดชบอร์ดสถิติการเข้าชม', 'รองรับทุกประเภทอสังหา', 'ค้นหาได้ทั้งภาษาไทยและอังกฤษ'],
  },
]
