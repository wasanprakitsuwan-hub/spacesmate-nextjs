...
function normalizeDbListing(raw: any): Property {
  ...
  return {
    ...
    image: (Array.isArray(raw.images) ? raw.images.find((img: string) => img.startsWith('https://')) : null) ?? '',
    images: Array.isArray(raw.images) ? raw.images.filter((img: string) => img.startsWith('https://')) : [],
