...
const TYPE_LABELS: Record<string, string> = {
  apartment: 'Apartment', condo: 'Condominium', office: 'Office Space', coworking: 'Co-Working Space', house: 'House',
}
...
export default async function AreaPageEn({ params }: Props) {
  const area = AREA_KEYWORDS.find(a => a.slug === params.slug)
  if (!area) notFound()
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <BreadcrumbLd
        trail={[
          { name: 'Home', url: 'https://spacesmate.com/en/' },
          { name: 'Search', url: 'https://spacesmate.com/search' },
          { name: area.label_en, url: `https://spacesmate.com/en/area/${params.slug}` },
        ]}
      />
      {/* Header */}
                  ...
                  <Link key={p.slug} href={`/property/${p.slug}`}
                    ...
                    <div style={{ padding: '14px 16px' }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: 15.5, fontWeight: 700, color: '#d97f11' }}>฿{p.price_from.toLocaleString()}/mo</span>
